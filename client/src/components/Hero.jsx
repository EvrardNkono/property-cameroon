...
const Hero = () => {
  ...
  // Images disponibles initiales (les labels sont maintenant statiques car l'image ne change pas)
  const initialImages = [
    { id: 'img0', src: '/images/heroimo.webp', label: t.realEstate, alt: 'Real Estate' },
    { id: 'img1', src: '/images/heroagri.webp', label: t.agriculture, alt: 'Agriculture' },
    { id: 'img2', src: '/images/lifstock.jfif', label: t.livestock, alt: 'Livestock' }
  ];
  ...
  useEffect(() => {
    setDisplayImages(prev => [
      { ...prev[0], label: t.realEstate },
      { ...prev[1], label: t.agriculture },
      { ...prev[2], label: t.livestock }
    ]);
  }, [currentLang, t.realEstate, t.agriculture, t.livestock]);
    ...
    <section id="hero-section" className="relative min-h-screen flex flex-col lg:flex-row items-center justify-between px-6 py-20 lg:py-28 lg:px-20 overflow-hidden bg-gradient-to-br from-white via-[#fafaf9] to-[#f5f4f0]">
      ...
      <div className="flex-1 relative w-full flex items-center justify-center lg:justify-end">
        <div className="relative w-full max-w-[450px] md:max-w-[550px] aspect-[4/3]">
          ...
          {/* --- 2. IMAGE SECONDAIRE (Haut Droite) - animation CSS pure --- */}
          <div 
          ...
          {/* --- 3. IMAGE TERTIAIRE (Bas Gauche) - animation CSS pure --- */}
          <div 
          ...
          {/* --- CAPEF BADGE --- */}
          <div className="absolute -bottom-4 right-0 md:-bottom-6 md:right-0 z-30 animate-float-fast">
            <Link 
