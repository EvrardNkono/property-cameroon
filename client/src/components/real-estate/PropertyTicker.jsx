...
const PropertyTicker = ({ properties, interval = 120000 }) => { // 2 minutes par défaut
  ...
  // Changement automatique toutes les X minutes
  ...
  return (
    ...
    >
      {/* Bandeau compact */}
      <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-slate-100 overflow-hidden hover:shadow-xl transition-all duration-300 max-w-sm">
