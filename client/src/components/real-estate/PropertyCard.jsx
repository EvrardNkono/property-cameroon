...
const PropertyCard = ({ property }) => {
  ...
  return (
    <div className="group bg-white border border-slate-100 hover:shadow-2xl transition-all duration-500 relative">
      {/* Image & Badges */}
      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-6 border-t border-slate-50 pt-5">
          ...
          {/* Verification Icon (Institutional Seriousness) */}
          <div className="ml-auto flex items-center gap-1 opacity-40 group-hover:opacity-100 transition-opacity">
             ...
             <span className="text-[8px] uppercase font-black tracking-tighter text-pc-green">Verified Title</span>
          </div>
        </div>
      </div>
    </div>
