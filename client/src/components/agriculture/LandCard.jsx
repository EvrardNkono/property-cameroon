            ...
            <div className="grid grid-cols-2 gap-4 py-6 border-y border-slate-50 mb-6">
              <div className="flex flex-col">
                <span className="text-[8px] uppercase font-black text-slate-400 mb-1 flex items-center gap-1">
                  <Gauge size={10} /> Soil Quality
                </span>
                <span className="text-sm font-bold text-slate-800">{land.soilQuality || 70}%</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[8px] uppercase font-black text-slate-400 mb-1 flex items-center gap-1">
                  <Droplets size={10} /> Water Access
                </span>
                <span className="text-sm font-bold text-slate-800">{land.waterAccess ? "Yes ✓" : "No"}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[8px] uppercase font-black text-slate-400 mb-1 flex items-center gap-1">
                  <Sprout size={10} /> Primary Crop
                </span>
                <span className="text-sm font-bold text-slate-800 capitalize">{land.primaryCrop || '—'}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-[8px] uppercase font-black text-slate-400 mb-1 flex items-center gap-1">
                  <TrendingUp size={10} /> Expected ROI
                </span>
