...
// 🔥 NOUVEAU : Composant pour gérer le scroll et forcer les re-rendus
const RouteChangeHandler = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (previousPath.current !== location.pathname) {
      ...
      // Hack pour forcer le rechargement des composants lazy
      const timer = setTimeout(() => {
        window.dispatchEvent(new Event('resize'));
        // Force un reflow du conteneur principal
        const mainContainer = document.querySelector('.main-content');
        if (mainContainer) {
          mainContainer.style.opacity = '0.99';
          setTimeout(() => {
...
// Styles globaux pour masquer Google Translate proprement
const globalStyles = `
...
function App() {
  ...
  return (
    <Router>
      <AuthProvider>
        <div className="App">
          {/* Navbar avec LanguageSwitcher intégré */}
          <Navbar />
          
          {/* Marge supérieure pour compenser la navbar fixe */}
          <div className="pt-32">
            <RouteChangeHandler>
