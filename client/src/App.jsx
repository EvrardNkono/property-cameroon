      ...
      <div class="bg-slate-50 rounded-xl p-6 my-6 border border-slate-200">
        <ul class="list-none space-y-3">
          <li class="flex justify-between items-center border-b border-slate-100 pb-2">
            <strong>${isFrench ? 'Prix d\'acquisition (Janvier)' : 'Acquisition Price (January)'}</strong>
            <span class="font-mono">1 500 FCFA/m²</span>
          </li>
          <li class="flex justify-between items-center border-b border-slate-100 pb-2">
            <strong>${isFrench ? 'Prix actuel du marché (Juillet)' : 'Current Market Price (July)'}</strong>
            <span class="font-mono text-pc-gold font-bold">5 500 FCFA/m²</span>
          </li>
          <li class="flex justify-between items-center border-b border-slate-100 pb-2">
            <strong>${isFrench ? 'Gain de valeur par m²' : 'Value Gain per m²'}</strong>
            <span class="font-mono text-emerald-600 font-bold">+4 000 FCFA</span>
          </li>
          <li class="flex justify-between items-center">
            <strong>${isFrench ? 'Pourcentage de bénéfice brut' : 'Gross Profit Percentage'}</strong>
            <span class="font-mono text-emerald-600 font-bold text-lg">+266,6 %</span>
          </li>
        </ul>
      </div>
...
// Articles similaires par défaut
const getDefaultRelatedPosts = (lang) => {
  const isFrench = lang === 'fr';
  return [
    {
      id: '1',
      slug: 'securiser-titre-foncier-cameroun',
      title: isFrench ? "Sécuriser votre Titre Foncier au Cameroun : Le Guide Complet 2026" : "Securing Your Land Title in Cameroon: The 2026 Comprehensive Guide",
      image: "https://images.unsplash.com/photo-1582407947304-fd86f028f716?auto=format&fit=crop&q=80",
      category: "Real Estate",
      date: isFrench ? "12 Avril 2026" : "April 12, 2026",
      content: ""
    },
    {
      id: '2',
      slug: 'essor-elevage-porcin',
      title: isFrench ? "L'essor de l'Élevage Porcin : Pourquoi Investir Maintenant" : "The Rise of Pig Farming: Why You Should Invest Now",
      image: "https://images.unsplash.com/photo-1516467508483-a7212febe31a?auto=format&fit=crop&q=80",
      category: "Agriculture",
      date: isFrench ? "10 Avril 2026" : "April 10, 2026",
      content: ""
    }
  ];
};
    ...
    const fetchPost = async () => {
      ...
      try {
        ...
        if (isHardcodedSlug(slug)) {
          ...
          setRelatedPosts(getDefaultRelatedPosts(currentLang));
          setLoading(false);
          return;
        }
